...
log.write(JSON.stringify({started_at:new Date().toISOString(),node:process.version,actual_head:execFileSync('git',['rev-parse','HEAD'],{cwd:root,encoding:'utf8'}).trim(),command:['npm','test']})+'\n');
