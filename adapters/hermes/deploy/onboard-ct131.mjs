...
try {
  ...
  if (!credential) {
    if (existsSync(agentKeyFile)) {
      throw new Error("Hermes key file exists without an active credential; refusing to overwrite it.");
    }
    ...
    throw new Error("Active Hermes credential exists but its recovery key file is missing.");
  }
