...
const memoryConfigPath = process.env.MNEMURON_MEMORY_CONFIG;
const memoryConfig = memoryConfigPath ? loadMemoryRuntimeFile(memoryConfigPath) : undefined;

const host = process.env.MNEMURON_HOST || "127.0.0.1";
const port = Number(process.env.MNEMURON_PORT || "47831");
const databasePath = process.env.MNEMURON_DATABASE_PATH || memoryConfig?.storage?.sqlite_path || "/var/lib/mnemuron/mnemuron.sqlite3";
