...
const [databasePath, runId, agentInstanceId, profile = "5m"] = process.argv.slice(2);
if (!databasePath || !runId || !agentInstanceId || !/^(5m|30m)$/u.test(profile)) {
  throw new Error("Usage: mnemuron-fr03-reconcile DATABASE RUN_ID AGENT_INSTANCE_ID [5m|30m]");
}
